...
import 'package:precios/pages/frm_edit_tienda.dart';
...
import 'package:precios/pages/productos_list.dart';
import 'package:precios/pages/tiendas_list.dart';
import 'package:precios/pages/tiendas_list2.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        'tiendas': (_) => const TiendasList2(),
        'listado_productos': (_) => const ProductosList(),
        'actualizar_tienda': (_) => const FrmEditTienda(),
      },
      theme: ThemeData(
